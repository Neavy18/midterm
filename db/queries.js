...
const insertResult = (userInput, sortingResult, db) => {
  ...
  return db.query(queryString, [userInput, sortingResult]).then((data) => {
    console.log("this is the  special data y'all ---->", data.rows[0]);
...
//Simple helper function(s) that is fetching database information
//from toDo Lists and making it accessible to front end
